        ...
        <table class="table table-hover">
            ...
            <c:forEach items="${list}" var="alog">
                <tr>
                    ...
                    <c:if test="${alog.status==0||alog.status==2}">
                    <td><a href="returnbook.html?bookId=<c:out value="${alog.bookId}"/>">
                        <button type="button" class="btn btn-danger btn-xs">归还</button></a>
                    </td>
                    </c:if>
                </tr>
            </c:forEach>
