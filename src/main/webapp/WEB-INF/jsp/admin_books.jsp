    ...
    <div class="panel-body">
        <table class="table table-hover">
            ...
            <tr>
                ...
                <td><c:out value="${book.className}"/></td>
                <td><c:out value="${book.price}"/></td>
                <td><c:out value="${book.number}"/></td>
                <td><a href="admin_book_detail.html?bookId=<c:out value="${book.bookId}"/>">
                    <button type="button" class="btn btn-success btn-xs">详情</button>
                </a></td>
                <td><a href="updatebook.html?bookId=<c:out value="${book.bookId}"/>">
                    <button type="button" class="btn btn-info btn-xs">编辑</button></a>
                </td>
