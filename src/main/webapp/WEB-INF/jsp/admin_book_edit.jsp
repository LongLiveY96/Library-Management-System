        ...
        <div class="panel-body">
            <form action="book_edit_do.html?bookId=${detail.bookId}" method="post" id="addbook" enctype="multipart/form-data">
                ...
                <div class="input-group" style="padding-top: 20px;">
                    ...
                    <input type="text" pattern="[0-9]{13}" maxlength="13"  class="form-control" name="isbn" id="isbn" value="${detail.isbn}">
                </div>
                <div class="input-group" style="padding-top: 20px;">
                    <span class="input-group-addon">简介</span>
                    <textarea rows="6" class="form-control" name="introduction"
                              id="introduction">${detail.introduction}</textarea>
                </div>
                <div class="input-group" style="padding-top: 20px;">
                ...
                <div class="input-group" style="padding-top: 20px;">
                    ...
                    <select name="classId" style="width: 150px;" class="form-control">
                        <option value="${detail.classId}" selected = "selected">${detail.className}</option>
                        <c:forEach items="${classInfo}" var="c">
                            <c:if test="${detail.classId != c.classId}">
                ...
                <div class="input-group" style="padding-top: 20px">
                    <img src="${detail.imgUrl}" style="height:180px"/>
                </div>
                <div class="input-group" style="padding-top: 20px">
                    <span class="input-group-addon">封面</span>
                    <input type="file" class="form-control" name="bookImg" id="bookImg">
                </div>
                    <input type="hidden" class="form-control" name="imgUrl" value="${detail.imgUrl}">
