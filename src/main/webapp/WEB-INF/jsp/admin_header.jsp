    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" >
            <ul class="nav navbar-nav navbar-left">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <li><a href="badList.html">惩罚日志</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="color: white">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="roleList.html">用户借阅限制管理</a></li>
                        <li class="divider"></li>
                        <li><a href="classList.html">图书类别管理</a></li>
                    </ul>
                </li>
                <li >
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="login.html" style="color: white">管理员${admin.userName}, 已登录</a>
                </li>
