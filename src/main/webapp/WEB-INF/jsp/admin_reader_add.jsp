        ...
        <div class="panel-body">
            <form action="reader_add_do.html" method="post" id="readeredit" >
                ...
                <div class="input-group" style="padding-top: 20px;">
                    ...
                    <input type="text" class="form-control" pattern="[1][3,4,5,7,8][0-9]{9}" minlength="11" maxlength="11" name="phone" id="phone"  >
                </div>
                <div class="input-group" style="padding-top: 20px;padding-bottom: 20px;">
                    <span class="input-group-addon">身份</span>
                    <select name="roleId" id= "roleId"style="width: 150px;" class="form-control">
                        <option value="" disabled selected hidden>请选择身份类别</option>
